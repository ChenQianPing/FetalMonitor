 ...
 */
- (LKCHeart *)startDecoderWithCharacterData:(NSData*)characteristicData;


/**
 * 开始记录监听数据，并同时记录并保存下 声音数据 和 胎心率数据
 */
- (void)startMonitor;


/**
 * 结束记录监听数据，并输入想要保存 声音数据地址文件地址 后缀为.wav
 */
- (void)stopMoniterWithAudioFilePath:(NSString *)audioFilePath;
